 ...
 * directly. The loader hooks register exactly where the patched profile-boot
 * used to call installStentBootstrap (boot prepare, before any target import) —
 * except no host source change is involved. It also records the process-local
 * stent-dsh launch capability before Host plugins can resolve their Stent
 * dependency.
 *
