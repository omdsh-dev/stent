/**
 * The Stent Client API module: a stable, Mod-facing surface for client
 ...
 * arbitration declarations to the narrow {@link StentSlotOptions} face.
 */
...
export class StentClientService extends Service {
   ...
   * @param options - the narrow registration face (see {@link StentSlotOptions}).
