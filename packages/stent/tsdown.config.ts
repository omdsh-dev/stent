...
/**
 * stent is a dual-face package: the loader half (public API, the
 ...
 * a private loader artifact the async loader fallback resolves. Orchestrion
...
export default [
  defineConfig({
    entry: {
      ...
      'loader/hook-entry': 'src/loader/hook-entry.ts',
